...
<div class="page-heading">
  <div class="page-title">
      <div class="row">
          <x-title-content :title="'Footer Content Edit'" :description="'this is for section two content'"/>
  ...
  <section class="section">
    <div class="card">
        <div class="card-body">
          <form action="/dashboard/footer/{{ $content->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
