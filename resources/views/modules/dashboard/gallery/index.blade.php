...
@section('title', 'Admin Dashboard - Gallery')
...
<div class="page-heading">
  <div class="page-title">
      <div class="row">
          <x-title-content :title="'Gallery Section'" :description="'this is for section one content'"/>
  ...
  <section class="section col-md-6 col-sm-12">
    <div class="card">
        <div class="card-body">
            ...
            <form action="/dashboard/gallery/edit-background" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex gap-3">
                ...
                <a class="btn btn-primary btn-sm d-flex" href="/dashboard/gallery/create">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2 align-items-center">
                                    <a class="btn btn-primary btn-sm" href="{{"/dashboard/gallery/".$image->id."/edit"}}">Edit</a>
                                    <form action="{{"/dashboard/gallery/".$image->id}}" method="POST">
                                        @csrf
                                        @method("DELETE")
